        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid ani">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                    <h3 class="mt-4 text-center"  style="font-weight: bolder; font-size: 2em;">Update Profile</h3>
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            ...
                            <div class="input-group col-md mb-3 mt-3">
                                <div class="custom-file">
                                    <input type="file" name='file' class="custom-file-input" id="profilepic" aria-describedby="profilepicinput" style="border-radius: 0.5em;">
                                    <label class="custom-file-label" for="profilepic">Change Photo</label>
                                </div>
                                <div class="input-group-append">
                                    <button class="btn" type="submit" name='but_upload' id="profilepicinput">Upload Picture</button>
                                </div>
                            </div>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                            <button class="btn btn-info" id="cp" type="submit" name='paschange'><a href="change_password.php" >Change Password</a></button>
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0.5em;" name="save" type="submit" >Save Changes</button>
                                </div>
                            </div>
                        </form>
                        <!--/tab-content-->
