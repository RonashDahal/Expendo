...
$expense_amt=$current_month_total;
?>
...
<head>
    ...
    <title>Expendo - Manage Expenses</title>
    ...
    <div class="row">
        <div class="col text-center">
            <div class="profit alert alert-success d-inline-block p-2 m-0" style="font-size: 1.3em; font-weight: bold; border-radius: 10px;">
                Expenses This Month: <span style="color:blue;" id="remaining
                expenses"><?php 
                if($expense_amt<=0){
                  echo "0";
                }else{
                            ...
                            <?php $count=1; while ($row = mysqli_fetch_array($exp_fetched)) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="add_expense.php?edit=<?php echo $row['expense_id']; ?>" class="btn btn-primary btn-sm" style="border-radius:15%;">Edit</a>
                                    </td>
                                    <td class="text-center">
    <a href="manage_expense.php?delete=<?php echo $row['expense_id']; ?>" 
