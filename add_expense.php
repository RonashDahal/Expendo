...
<head>
    ...
    <title>Expendo - Add Expense</title>
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Amount(NPR) -</b></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <?php else : ?>
                                        <button type="submit" name="add" class="btn btn-lg btn-block btn-success" style="border-radius: 0.5em;">Add Expense</button>
                                    <?php endif ?>
                                </div>
                            </div>
                        </form>
